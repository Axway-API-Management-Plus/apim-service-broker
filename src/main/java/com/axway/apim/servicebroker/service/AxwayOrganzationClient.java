...
public class AxwayOrganzationClient implements Constants {
	...
	public String createOrganization(String orgName, String email, String serviceInstanceId) {
		...
		URI uri = UriComponentsBuilder.fromUriString(apiManagerURL).path(API_BASEPATH).path("/organizations").build().toUri();
	...
	public void deleteOrganization(String orgId){
		...
		URI uri = UriComponentsBuilder.fromUriString(apiManagerURL).path(API_BASEPATH).path("/organizations/").path(orgId).build()
				.toUri();
	...
	public String getOrganizationId(String orgName) {
		URI uri = UriComponentsBuilder.fromUriString(apiManagerURL).path(API_BASEPATH).path("/organizations")
